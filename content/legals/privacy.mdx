...
Please read this privacy policy carefully as it contains important information about how we use personal data that you provide to us or we collect from you/third parties when operating our business, for example, when you visit the HumanForest website [parcel.humanforest.co.uk]() (this/our "**Site**") and when you use our services via the Site.
